\titre{déterminants}{Polynômes caractéristiques, théorème de Cayley-Hamilton}
...
\end{defini}
\begin{prop}[Signature d'une transpositions]
...
\end{prop}
\begin{theoreme}[Morphisme signature]
...
\begin{defini}[Applications multilinéaires]
...
\end{defini}
\begin{ex}[Sur les applications n-linéaire]
    \begin{itemize}
        ...
        \item Les applications produit sont bilinéaire ; $f:\K\times\K\to\K;(x,y)\mapsto x.y$; $\varphi:\mathcal{M}_n(\K)\times\mathcal{M}_n(\K)\to\mathcal{M}_n(\K); (A,B)\to A.B$ $\phi:\mathcal{L}(E)\times\mathcal{L}(E)\to\mathcal{L}(E); (f,g)\to f\circ g$
    \end{itemize}
\end{ex}
